...
class ZonecryptokeyApi(object):
    ...
    def create_cryptokey(self, body, server_id, zone_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_cryptokey(body, server_id, zone_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Cryptokey body: Add a Cryptokey (required)
        ...
        if kwargs.get('async_req'):
            return self.create_cryptokey_with_http_info(body, server_id, zone_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_cryptokey_with_http_info(body, server_id, zone_id, **kwargs)  # noqa: E501
            return data

    def create_cryptokey_with_http_info(self, body, server_id, zone_id, **kwargs):  # noqa: E501
        """Creates a Cryptokey  # noqa: E501

        This method adds a new key to a zone. The key can either be generated or imported by supplying the content parameter. if content, bits and algo are null, a key will be generated based on the default-ksk-algorithm and default-ksk-size settings for a KSK and the default-zsk-algorithm and default-zsk-size options for a ZSK.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_cryptokey_with_http_info(body, server_id, zone_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_cryptokey`")  # noqa: E501
    ...
    def modify_cryptokey(self, body, server_id, zone_id, cryptokey_id, **kwargs):  # noqa: E501
        """This method (de)activates a key from zone_name specified by cryptokey_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_cryptokey(body, server_id, zone_id, cryptokey_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Cryptokey body: the Cryptokey (required)
        :param str server_id: The id of the server to retrieve (required)
        :param str zone_id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.modify_cryptokey_with_http_info(body, server_id, zone_id, cryptokey_id, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_cryptokey_with_http_info(body, server_id, zone_id, cryptokey_id, **kwargs)  # noqa: E501
            return data

    def modify_cryptokey_with_http_info(self, body, server_id, zone_id, cryptokey_id, **kwargs):  # noqa: E501
        """This method (de)activates a key from zone_name specified by cryptokey_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_cryptokey_with_http_info(body, server_id, zone_id, cryptokey_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'server_id', 'zone_id', 'cryptokey_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `modify_cryptokey`")  # noqa: E501
        # verify the required parameter 'server_id' is set
        if ('server_id' not in params or
                params['server_id'] is None):
