...
class TsigkeyApi(object):
    ...
    def create_tsig_key(self, body, server_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_tsig_key(body, server_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TSIGKey body: The TSIGKey to add (required)
        ...
        if kwargs.get('async_req'):
            return self.create_tsig_key_with_http_info(body, server_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_tsig_key_with_http_info(body, server_id, **kwargs)  # noqa: E501
            return data

    def create_tsig_key_with_http_info(self, body, server_id, **kwargs):  # noqa: E501
        """Add a TSIG key  # noqa: E501

        This methods add a new TSIGKey. The actual key can be generated by the server or be provided by the client  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_tsig_key_with_http_info(body, server_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_tsig_key`")  # noqa: E501
    ...
    def put_tsig_key(self, body, server_id, tsigkey_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tsig_key(body, server_id, tsigkey_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TSIGKey body: A (possibly stripped down) TSIGKey object with the new values (required)
        :param str server_id: The id of the server to retrieve the key from (required)
        :param str tsigkey_id: The id of the TSIGkey. Should match the \"id\" field in the TSIGKey object (required)
        :return: TSIGKey
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_tsig_key_with_http_info(body, server_id, tsigkey_id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_tsig_key_with_http_info(body, server_id, tsigkey_id, **kwargs)  # noqa: E501
            return data

    def put_tsig_key_with_http_info(self, body, server_id, tsigkey_id, **kwargs):  # noqa: E501
        """put_tsig_key  # noqa: E501

        The TSIGKey at tsigkey_id can be changed in multiple ways:  * Changing the Name, this will remove the key with tsigkey_id after adding.  * Changing the Algorithm  * Changing the Key  Only the relevant fields have to be provided in the request body.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tsig_key_with_http_info(body, server_id, tsigkey_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'server_id', 'tsigkey_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_tsig_key`")  # noqa: E501
        # verify the required parameter 'server_id' is set
        if ('server_id' not in params or
                params['server_id'] is None):
