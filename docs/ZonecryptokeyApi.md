# powerdns_async_client.ZonecryptokeyApi
...
# **create_cryptokey**
> Cryptokey create_cryptokey(body, server_id, zone_id)
...
api_instance = powerdns_async_client.ZonecryptokeyApi(powerdns_async_client.ApiClient(configuration))
body = powerdns_async_client.Cryptokey() # Cryptokey | Add a Cryptokey
server_id = 'server_id_example' # str | The id of the server to retrieve
zone_id = 'zone_id_example' # str | 

try:
    # Creates a Cryptokey
    api_response = api_instance.create_cryptokey(body, server_id, zone_id)
    pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **body** | [**Cryptokey**](Cryptokey.md)| Add a Cryptokey | 
...
# **modify_cryptokey**
> modify_cryptokey(body, server_id, zone_id, cryptokey_id)
...
# create an instance of the API class
api_instance = powerdns_async_client.ZonecryptokeyApi(powerdns_async_client.ApiClient(configuration))
body = powerdns_async_client.Cryptokey() # Cryptokey | the Cryptokey
server_id = 'server_id_example' # str | The id of the server to retrieve
zone_id = 'zone_id_example' # str | 
...
try:
    # This method (de)activates a key from zone_name specified by cryptokey_id
    api_instance.modify_cryptokey(body, server_id, zone_id, cryptokey_id)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**Cryptokey**](Cryptokey.md)| the Cryptokey | 
 **server_id** | **str**| The id of the server to retrieve | 
 **zone_id** | **str**|  | 
