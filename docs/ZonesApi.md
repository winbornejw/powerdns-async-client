# powerdns_async_client.ZonesApi
...
api_instance = powerdns_async_client.ZonesApi(powerdns_async_client.ApiClient(configuration))
...
# **create_zone**
> Zone create_zone(body, server_id, rrsets=rrsets)
...
# create an instance of the API class
api_instance = powerdns_async_client.ZonesApi(powerdns_async_client.ApiClient(configuration))
body = powerdns_async_client.Zone() # Zone | The zone struct to patch with
server_id = 'server_id_example' # str | The id of the server to retrieve
...
try:
    # Creates a new domain, returns the Zone on creation.
    api_response = api_instance.create_zone(body, server_id, rrsets=rrsets)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**Zone**](Zone.md)| The zone struct to patch with | 
 **server_id** | **str**| The id of the server to retrieve | 
...
# **patch_zone**
> patch_zone(body, server_id, zone_id)
...
try:
    # Creates/modifies/deletes RRsets present in the payload and their comments. Returns 204 No Content on success.
    api_instance.patch_zone(body, server_id, zone_id)
except ApiException as e:
...
# **put_zone**
> put_zone(body, server_id, zone_id)
...
try:
    # Modifies basic zone data.
    api_instance.put_zone(body, server_id, zone_id)
except ApiException as e:
